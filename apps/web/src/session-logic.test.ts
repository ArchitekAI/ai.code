import { EventId, MessageId, TurnId, type OrchestrationThreadActivity } from "@repo/contracts";
...
describe("PROVIDER_OPTIONS", () => {
  it("keeps Claude Code available in the stack base while leaving Cursor disabled", () => {
