...
export function createWsNativeApi(): NativeApi {
  ...
  const api: NativeApi = {
    ...
    git: {
      ...
      archiveWorktree: (input) => transport.request(WS_METHODS.gitArchiveWorktree, input),
      unarchiveWorktree: (input) => transport.request(WS_METHODS.gitUnarchiveWorktree, input),
