    ...
    projects: [
      {
        ...
        name: "Project",
        cwd: "/tmp/project",
        managedWorktreeRoot: "/Users/test/.t3/worktrees/project",
        model: "gpt-5-codex",
      ...
      projects: [
        {
          ...
          name: "Project 1",
          cwd: "/tmp/project-1",
          managedWorktreeRoot: "/Users/test/.t3/worktrees/project-1",
        ...
        },
        {
          ...
          name: "Project 2",
          cwd: "/tmp/project-2",
          managedWorktreeRoot: "/Users/test/.t3/worktrees/project-2",
          model: DEFAULT_MODEL_BY_PROVIDER.codex,
          defaultWorktreeBaseBranch: null,
          defaultPullRequestBaseBranch: null,
          pullRequestPromptTemplate: null,
        ...
        },
        {
          ...
          name: "Project 3",
          cwd: "/tmp/project-3",
          managedWorktreeRoot: "/Users/test/.t3/worktrees/project-3",
          model: DEFAULT_MODEL_BY_PROVIDER.codex,
          defaultWorktreeBaseBranch: null,
          defaultPullRequestBaseBranch: null,
          pullRequestPromptTemplate: null,
...
describe("store read model sync", () => {
  it("infers the Claude provider from stored Claude model slugs without an active session", () => {
