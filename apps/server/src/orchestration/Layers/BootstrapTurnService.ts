...
} from "../Services/BootstrapTurnService.ts";
...
const makeBootstrapTurnService = Effect.gen(function* () {
  ...
  const dispatch: BootstrapTurnServiceShape["dispatch"] = (normalizedCommand) => {
  ...
  return {
    dispatch,
  } satisfies BootstrapTurnServiceShape;
});

export const BootstrapTurnServiceLive = Layer.effect(
  BootstrapTurnService,
  makeBootstrapTurnService,
);
