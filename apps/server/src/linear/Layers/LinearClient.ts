      ...
      Effect.flatMap((client) =>
        Effect.tryPromise({
          try: async () => {
            ...
            const project =
              "project" in issue && issue.project
                ? await (issue.project as Promise<unknown>)
                : null;
      ...
      Effect.flatMap((client) =>
        Effect.tryPromise({
          try: async () => {
            ...
            new LinearActivitySinkError({
              detail: `Failed to fetch Linear issue comments for ${issueId}.`,
              cause,
            }),
        }),
      ),
      ...
      Effect.flatMap((client) =>
        Effect.tryPromise({
          try: async () => {
            ...
            new LinearActivitySinkError({
              detail: `Failed to fetch Linear issue state for ${issueId}.`,
              cause,
            }),
        }),
      ),
      ...
      Effect.flatMap((client) =>
        Effect.tryPromise({
          try: async () => {
            ...
            new LinearActivitySinkError({
              detail: "Failed to upload file to Linear.",
              cause,
            }),
        }),
      ),
      ...
      Effect.flatMap((client) =>
        Effect.tryPromise({
          try: async () => {
            ...
            new LinearActivitySinkError({
              detail: `Failed to create Linear agent session on issue ${issueId}.`,
              cause,
            }),
        }),
      ),
      ...
      Effect.flatMap((client) =>
        Effect.tryPromise({
          try: async () => {
            ...
            new LinearActivitySinkError({
              detail: `Failed to create Linear agent session on comment ${commentId}.`,
              cause,
            }),
        }),
      ),
          ...
          try: async () => {
            const connection = await client.agentSessions({
              ...
              ...(input.orderBy !== undefined
                ? { orderBy: input.orderBy as PaginationOrderBy }
                : {}),
            });
            ...
            new LinearActivitySinkError({
              detail: "Failed to list Linear agent sessions.",
              cause,
            }),
        }),
      ),
      ...
      Effect.flatMap((client) =>
        Effect.tryPromise({
          try: async () => {
            ...
            new LinearActivitySinkError({
              detail: `Failed to fetch Linear agent session ${sessionId}.`,
              cause,
            }),
        }),
      ),
      ...
      Effect.flatMap((client) =>
        Effect.tryPromise({
          try: async () => {
            ...
            new LinearActivitySinkError({
              detail: `Failed to create Linear issue relation for ${input.issueId}.`,
              cause,
            }),
        }),
      ),
      ...
      Effect.flatMap((client) =>
        Effect.tryPromise({
          try: async () => {
            ...
            return await Promise.all(
              connection.nodes.map(async (child): Promise<LinearChildIssue> => {
                ...
                return {
                  ...
                  ...(child.archivedAt ? { archivedAt: child.archivedAt.toISOString() } : {}),
                };
              }),
            );
          },
            ...
            new LinearActivitySinkError({
              detail: `Failed to list child issues for ${input.issueId}.`,
              cause,
            }),
        }),
      ),
