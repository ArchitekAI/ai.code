...
import { BootstrapTurnService } from "./orchestration/Services/BootstrapTurnService";
  ...
  Effect.gen(function* () {
    ...
    const loadServerConfig = Effect.gen(function* () {
      ...
      return {
        ...
        providers,
        availableEditors: config.mode === "remote" ? [] : resolveAvailableEditors(),
        observability: {
    ...
    return WsRpcGroup.of({
        ...
        observeRpcEffect(
          ...
          Effect.gen(function* () {
            ...
            const result = yield* startup
              .enqueueCommand(bootstrapTurnService.dispatch(normalizedCommand))
              .pipe(
      ...
      [WS_METHODS.shellOpenInEditor]: (input) =>
        observeRpcEffect(
          ...
          config.mode === "remote"
            ? Effect.fail(
                new OpenError({ message: "Open in editor is not available in remote mode." }),
              )
