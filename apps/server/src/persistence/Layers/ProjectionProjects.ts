...
import { ProjectScript } from "@repo/contracts";
    ...
    execute: (row) =>
      sql`
            ...
            VALUES (
              ...
              ${row.workspaceRoot},
              ${row.defaultModel},
              ${row.defaultWorktreeBaseBranch},
              ${row.defaultPullRequestBaseBranch},
              ${row.pullRequestPromptTemplate},
              ${row.scripts},
              ${row.createdAt},
              ${row.updatedAt},
              ${row.deletedAt}
            ...
            DO UPDATE SET
              ...
              default_worktree_base_branch = excluded.default_worktree_base_branch,
              default_pull_request_base_branch = excluded.default_pull_request_base_branch,
              pull_request_prompt_template = excluded.pull_request_prompt_template,
    ...
    execute: ({ projectId }) =>
      sql`
        SELECT
          ...
          pull_request_prompt_template AS "pullRequestPromptTemplate",
