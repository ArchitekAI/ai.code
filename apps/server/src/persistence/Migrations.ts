...
import Migration0020 from "./Migrations/020_LinearSessions.ts";
import Migration0021 from "./Migrations/021_ThreadRelationships.ts";
...
export const migrationEntries = [
  ...
  [20, "LinearSessions", Migration0020],
  [21, "ThreadRelationships", Migration0021],
] as const;
